...
Route::get('/start-game/d07fe97541d6da8e4ee3368c9c782bf6', [GridController::class, 'mission5'])->name('grid5');
Route::get('/start-game/8274281b6f909119ad5eb0fbf2b25f22', [GridController::class, 'mission6'])->name('grid6');
Route::get('/start-game/8405ccfb0eb4fe8fe977b1f86179407e', [GridController::class, 'mission7'])->name('grid7');