...
<head>
    ...
    <title>StdvGame - Mission 7</title>
...
<body>
                    ...
                    <!-- <form action="{{ route('grid7') }}" method="post" class="w-[100%] h-[100%] flex items-center justify-center">
                        ...
                        <div class="space-x-5" style="width: 100%; ">
                            ...
                            <div class="inline-flex items-center space-x-3 text-xl text-center justify-center mt-2 ml-10 text-[#FFF]">
                                ...
                                <h1 style="font-family: 'Nunito Sans'; font-size: 48px; line-height: 65.47px;">√</h1>
                                <input type="text" id="variance" name="variance" class="w-40 h-10 rounded text-center" value="{{ $variance }}" style="border: 2px solid #FFF; background:none;" disabled>
                            ...
                            <div class="inline-flex items-center space-x-3 text-xl text-center justify-center mt-2 ml-10 text-[#FFF]">
                                ...
                                <h1 style="font-family: 'Nunito Sans'; font-size: 48px; line-height: 65.47px;">=</h1>
                                <input type="text" id="sqrVar" name="sqrVar" class="w-40 h-10 rounded text-center" value="" style="border: 2px solid #FFF; background:none;">
    ...
    <script>
        ...
        var sd = document.getElementById("sqrVar");
